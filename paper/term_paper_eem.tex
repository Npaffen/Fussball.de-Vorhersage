...
difference of the result. Thus, K is increased by \(K/2\) if the match
was won with two goals, by \(3/4\times K\) if the match was won with
three goals and by \(3/4 + (N-3)/8 \times K\), where N defines the goal
