...
nbinom_plot<- function(sim_years){
  ...
  png(here::here(paste0("paper/plots/nbiom_actual_home_",sim_years,".png")))
 ...
 png(here::here(paste0("paper/plots/nbiom_actual_away_",sim_years,".png")))
